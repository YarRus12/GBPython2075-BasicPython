def sum_list_1(dataset: list) -> int:
    ...
    for i in dataset:
        number = i # присваиваем новой переменной значение очередного числа
        ...
        if sum_i % 7 == 0: #если малый счетчик делится на 7 без остатка, то добавляем число к большому локальному счетчику
            total_sum += number
    return total_sum
